...
export interface LsInterface extends utils.Interface {
  functions: {
    "allowance(address,address)": FunctionFragment;
    "amountLimit()": FunctionFragment;
    ...
    "setRule(bool,uint256)": FunctionFragment;
...
export interface Ls extends BaseContract {
  ...
  functions: {
    ...
    amountLimit(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  populateTransaction: {
    ...
    amountLimit(overrides?: CallOverrides): Promise<PopulatedTransaction>;
